package com.slobodsky.nick.tictactoe;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private boolean checkForWin()
    {
        ...
        if (field[2][0].equals(field[1][1]) && field[2][0].equals(field[0][2]) &&
                !field[2][0].equals(""))
        {
            return true;
        }
    ...
    private void draw()
    {
        Toast.makeText(MainActivity.this, " A draw ! ", Toast.LENGTH_SHORT).show();
